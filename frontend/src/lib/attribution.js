...
const UTM_PARAMS = [
  ...
  "utm_id", "ad_id", "adset_id", "placement", "site_source_name"
];
...
export function getAttribution() {
  ...
  return {
    ...
    utm_ad: last.utm_ad || first.utm_ad || null,
    // ad identifiers (CR-25)
    utm_id: last.utm_id || first.utm_id || null,
    ad_id: last.ad_id || first.ad_id || null,
    adset_id: last.adset_id || first.adset_id || null,
    placement: last.placement || first.placement || null,
    site_source_name: last.site_source_name || first.site_source_name || null,
    // click ids
