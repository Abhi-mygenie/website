...
export const PRODUCT_PAGES = {
  "sell-serve": {
    title: "Sell & Serve Faster", icon: "ShoppingBag", image: "/brand/feature1.webp", videoUrl: null,
    eyebrow: "Sell & Serve",
    ...
    modules: [
      { icon: "ReceiptText", name: "POS Billing", outcome: "Restaurant POS system billing in seconds, even at peak rush.", caps: ["Lightning-fast billing on any device", "Split, merge & hold bills", "GST / VAT-ready invoices"] },
      ...
      { icon: "QrCode", name: "QR Menu & Scan Order", outcome: "QR menu — guests scan, order and pay from their phone.", caps: ["No app needed", "Contactless payments", "Fewer staff at peak"] },
  ...
  "run-property": {
    title: "Run the Whole Property", icon: "Building", image: "/brand/feature2.webp", videoUrl: null,
    ...
    modules: [
      { icon: "BedDouble", name: "Hotel / Room Billing", outcome: "Hotel management dashboard — rooms, F&B, spa and bar on one consolidated checkout bill.", caps: ["Folio & room posting", "One checkout bill", "Department-wise tracking"] },
      ...
      { icon: "ReceiptText", name: "Single Checkout Bill", outcome: "Everything a guest used, on one clean bill — live analytics from your phone.", caps: ["Cross-department merge", "Tax compliant", "Faster checkout"] },
    ],
  ...
  "customers": {
    title: "Bring Customers Back", icon: "HeartHandshake", image: "/brand/feature3.webp", videoUrl: null,
    ...
    modules: [
      { icon: "Users", name: "CRM", outcome: "Customer management made easy — every bill becomes data you can action.", caps: ["Auto customer profiles", "Visit & spend history", "Smart segmentation"] },
      { icon: "Gift", name: "Loyalty", outcome: "Loyalty program that rewards regulars automatically and lifts repeat visits.", caps: ["Points & tiers", "Automatic rewards", "Visit-based triggers"] },
  ...
  "protect-profit": {
    title: "Protect Your Profit", icon: "ShieldCheck", image: "/brand/feature4.webp", videoUrl: null,
    ...
    modules: [
      ...
      { icon: "ShieldCheck", name: "Audit Reports", outcome: "Theft prevention analytics — every void, cancel and discount on the record.", caps: ["Full action logs", "Discount tracking", "Theft detection"] },
      { icon: "CheckCheck", name: "Smart Validations", outcome: "Cash management and billing validation — stop mistakes and discount misuse at the source.", caps: ["Rule-based checks", "Approval flows", "Error prevention"] },
    ],
  ...
  "see-everything": {
    title: "See Everything", icon: "LayoutDashboard", image: "/brand/feature5.webp", videoUrl: null,
    ...
    modules: [
      ...
      { icon: "BarChart3", name: "Reports", outcome: "Daily sales report and analytics — item-wise, payment-mode, staff — all automatic.", caps: ["Scheduled reports", "Drill-downs", "One-tap export"] },
  ...
  "central-inventory": {
    ...
    modules: [
      { icon: "Network", name: "Multi-Outlet Stock Visibility", outcome: "Inventory management across every outlet — live stock, one dashboard.", caps: ["Real-time stock per outlet", "Consolidated stock view", "Low-stock alerts by location"] },
      { icon: "ArrowLeftRight", name: "Inter-Outlet Transfers", outcome: "Inventory management transfers — move stock between outlets in a tap, fully tracked.", caps: ["Outlet-to-outlet transfers", "Transfer approvals", "Complete audit trail"] },
      { icon: "ShoppingCart", name: "Central Procurement", outcome: "Central stock management — buy centrally, distribute smartly, negotiate better rates.", caps: ["Central purchase orders", "Vendor management", "Outlet indents & requisitions"] },
      { icon: "Sparkles", name: "AI Auto-Reorder & Forecast", outcome: "AI-powered inventory management — predicts demand and suggests what to reorder, per outlet.", caps: ["Demand forecasting", "Par-level suggestions", "Fewer stock-outs & less overstock"] },
      { icon: "ChefHat", name: "Central Recipe & BOM Costing", outcome: "Recipe management and food cost control — standardise recipes and BOM costs across every outlet.", caps: ["Central recipe library", "BOM-level costing", "Consistent margins"] },
