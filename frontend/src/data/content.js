...
export const TESTIMONIALS = [
  ...
  { metric: "30%", headline: "faster room service, 2x tips", quote: "MyGenie synced waitstaff and kitchen in real time. Orders are fulfilled 30% faster, upsell improved, and guest tips nearly doubled.", client: "Palm Forest Resort", sector: "Hotel / Resort", img: "/brand/palmforest.webp" },
  { metric: "40%", headline: "lower fixed cost on 3 devices", quote: "We run the entire shack on just 3 mobile devices. No front desk, no printers. Table turnaround improved 25% and monthly cost dropped 40%.", client: "Love Bites", sector: "Café", img: "/brand/lovebites.webp" },
];
