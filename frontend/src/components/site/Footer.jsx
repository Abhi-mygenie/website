        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-10">
          <div className="col-span-2">
            ...
            <div className="mt-4 flex items-center gap-3">
              <a href={COMPANY.social.youtube} target="_blank" rel="noopener noreferrer" aria-label="YouTube" data-testid="footer-youtube" className="w-9 h-9 rounded-lg bg-white/10 flex items-center justify-center hover:bg-brand-green transition-colors"><Youtube className="w-4.5 h-4.5" style={{ width: 18, height: 18 }} /></a>
              <a href={COMPANY.social.facebook} target="_blank" rel="noopener noreferrer" aria-label="Facebook" data-testid="footer-facebook" className="w-9 h-9 rounded-lg bg-white/10 flex items-center justify-center hover:bg-brand-green transition-colors"><Facebook className="w-4.5 h-4.5" style={{ width: 18, height: 18 }} /></a>
            </div>
          </div>
