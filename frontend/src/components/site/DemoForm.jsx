...
export default function DemoForm({ sector, shortForm = false, submitLabel, autoFocusName = false }) {
  ...
  const [isMobile, setIsMobile] = useState(false); // safe default matches prerender (puppeteer = desktop)
        ...
        {[
          ...
          <div key={key}>
            <input
              ...
              onBlur={() => blur(key)}
              autoFocus={autoFocusName && key === "name"}
