...
const EMPTY = { name: "", phone: "", email: "", outlet_type: "", business_name: "", city: "", years_in_business: "", using_pos: "" };
  ...
  return (
    <form onSubmit={submit} className={cardCls} data-testid="demo-form">
      ...
      <div className="space-y-3.5">
        ...
        <select className={field} value={form.years_in_business} onChange={(e) => update("years_in_business", e.target.value)} data-testid="demo-select-years">
