    ...
    >
      ...
      <div className="flex items-center gap-2 shrink-0">
        <button
          ...
          className="px-3 py-[14px] rounded-full border border-white/20 text-xs font-medium text-[#9DB1A4] hover:text-white hover:border-white/40 transition-colors"
        >
          Decline
        </button>
        <button
          ...
          className="px-3 py-[14px] rounded-full bg-brand-green hover:bg-brand-greenDark text-xs font-semibold text-white transition-colors"
        >
          Accept
        </button>
      </div>
