    ...
    >
      ...
      <div className="bg-brand-deep border-t border-brand-green/30 px-4 pt-3 pb-[calc(0.75rem+env(safe-area-inset-bottom,0px))] flex items-center gap-3 shadow-[0_-8px_30px_rgba(0,0,0,0.25)]">
        <button
          ...
          className="flex-1 bg-brand-green hover:bg-brand-greenDark active:scale-[0.98] text-white font-bold rounded-full py-3.5 flex items-center justify-center gap-2 text-[15px] transition-colors shadow-[0_6px_18px_rgba(24,168,74,0.35)]"
        >
          Book a Free Demo
