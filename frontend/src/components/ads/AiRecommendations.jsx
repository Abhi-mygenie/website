  ...
  if (insights?.error) {
    return (
      <div className="px-4 py-3 bg-red-50 border-b border-slate-100">
        ...
        <button type="button" onClick={() => setInsights(null)} className="text-xs text-slate-500 underline mt-1">Try again</button>
      </div>
    );
  }
  ...
  return (
    <div className="border-b border-slate-100 bg-gradient-to-r from-violet-50 to-blue-50" data-testid="ai-insights-panel">
      <div className="px-4 py-3 flex items-center justify-between border-b border-violet-100">
        ...
        <button type="button" onClick={() => setInsights(null)} className="text-xs text-slate-400 hover:text-slate-600 underline">Regenerate</button>
      </div>
