  ...
  return (
    <div className="flex flex-col gap-6" data-testid="ads-intel-tab">
      ...
      <section className="bg-white border border-slate-200 rounded-lg px-4 py-3 flex flex-wrap items-center gap-3">
        ...
        {activePreset === "Custom" && (
          <button type="button" onClick={handleApply} data-testid="ads-filter-apply"
            disabled={syncing}
      ...
      {syncResult && (
        <div data-testid="sync-result-banner"
          ...
          <button type="button" onClick={() => setSyncResult(null)} className="ml-auto text-xs underline opacity-60 hover:opacity-100">
            dismiss
          </button>
        </div>
      )}
      ...
      {gadsBanner && (
        <div data-testid="google-ads-banner"
          ...
          <button type="button" onClick={() => setGadsBanner(null)} className="ml-auto text-xs underline opacity-60 apply:opacity-100">
            dismiss
          </button>
        </div>
      )}
