      ...
      <div className="flex items-center gap-2 pt-1">
        ...
        {tag === "explore" && (
          <span className="flex items-center gap-1 text-xs font-semibold text-emerald-700">
            ...
            <button type="button" onClick={() => setTag(null)} className="ml-2 text-slate-400 hover:text-slate-600 underline font-normal">undo</button>
          </span>
        )}
        {tag === "saved" && (
        ...
        {tag === "skipped" && (
          <span className="flex items-center gap-1 text-xs text-slate-400">
            <X size={11} /> Skipped
            <button type="button" onClick={() => setTag(null)} className="ml-2 text-slate-500 hover:text-slate-700 underline">undo</button>
          </span>
        )}
      </div>
    </div>
