          ...
          <div key={i} className="border border-brand-line rounded-xl p-4 mb-4 space-y-3">
            <div className="flex justify-between">
              ...
              <div className="flex gap-1">
                ...
                <button type="button" onClick={() => move(i, 1)} className="text-xs px-2 py-1 border border-brand-line rounded">↓</button>
                <button type="button" onClick={() => remove(i)} data-testid={`faq-delete-${id}-${i}`} className="text-xs px-2 py-1 border border-brand-line rounded text-red-600">Delete</button>
              </div>
            </div>
