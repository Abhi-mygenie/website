...
const BUY_ONLINE_ENABLED = process.env.REACT_APP_BUY_ONLINE_ENABLED === "true";
      ...
      <div className="p-6">
        {isCustom ? (
          <>
            ...
            <button type="button" onClick={onDemo} data-testid="cart-demo-btn" className="mt-3 w-full bg-brand-orange hover:bg-brand-orange/90 text-white rounded-full py-3.5 font-semibold transition-all flex items-center justify-center gap-2">
          ...
          <>
            ...
            {BUY_ONLINE_ENABLED && (
              <button type="button" onClick={onBuy} data-testid="cart-buy-btn" className="group mt-5 w-full bg-brand-green hover:bg-brand-greenDark text-white rounded-full py-3.5 font-semibold transition-all hover:-translate-y-0.5 shadow-[0_8px_22px_rgba(24,168,74,0.3)] flex items-center justify-center gap-2">
                Buy Online <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </button>
            )}
            <button type="button" onClick={onDemo} data-testid="cart-demo-btn" className="mt-3 w-full bg-white border-2 border-brand-orange/40 text-brand-orange hover:bg-brand-orange hover:text-white rounded-full py-3 font-semibold transition-all flex items-center justify-center gap-2">
