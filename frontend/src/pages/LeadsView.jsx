...
import ChurnPanel from "../components/funnel/ChurnPanel";
...
export default function LeadsView() {
  ...
  const [activeTab, setActiveTab] = useState("funnel"); // "funnel" | "ads" | "churn"
          ...
          <div className="flex items-center gap-2">
            ...
            <div data-testid="leads-tab-bar" className="flex rounded-lg border border-slate-200 overflow-hidden text-xs font-semibold">
              ...
              <button
                ...
                className={`px-4 py-2 transition-colors border-l border-slate-200 ${activeTab === "churn" ? "bg-slate-900 text-white" : "bg-white text-slate-500 hover:bg-slate-50"}`}
              >
                Churned Clients
              </button>
            </div>
            {activeTab === "funnel" && (
              <>
                <button type="button" data-testid="leads-sync-crm" onClick={async () => {
                  try {
                    await fetch(`${API}/api/cms/sync/trigger`, {
                ...
                <button type="button" data-testid="leads-refresh" onClick={() => load(page)}
                ...
                <button type="button" data-testid="leads-export-csv" onClick={exportCsv}
            ...
            <button type="button" data-testid="leads-signout" onClick={signOut}
              className="inline-flex items-center gap-1.5 rounded-lg border border-slate-300 px-3 py-2 text-sm text-slate-600 hover:bg-slate-50">
          ...
          <div data-testid="delete-modal-overlay" className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
            <div data-testid="delete-modal" className="bg-white rounded-xl shadow-lg max-w-sm w-full mx-4 p-6">
              ...
              <div className="mt-5 flex justify-end gap-2">
                <button type="button" data-testid="delete-modal-cancel" onClick={() => setDeleteTarget(null)}
                  className="px-4 py-2 text-sm rounded-lg border border-slate-300 text-slate-600 hover:bg-slate-50">
                  Cancel
                </button>
                <button type="button" data-testid="delete-modal-confirm" onClick={handleDeleteLead}
