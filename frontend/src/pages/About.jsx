...
import { PAGE_SEO, ORG_JSONLD, SITE_URL } from "@/lib/seo";
...
const BREADCRUMB_JSONLD = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "About MyGenie", item: `${SITE_URL}/about` },
  ],
};
...
export default function About() {
  ...
  return (
    <div className="bg-white" data-testid="about-page">
      <Seo title={seo.title} description={seo.description} path="/about" jsonLd={[ORG_JSONLD, BREADCRUMB_JSONLD]} />
      <Navbar onDemo={() => setSheetOpen(true)} />
      <main>
        <section className="pt-20 pb-16 lg:pt-40">
        ...
        <section className="py-20 sm:py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
            ...
            <Reveal delay={0.1}><DemoForm sector="about" shortForm /></Reveal>
          </div>
        </section>
      </main>
      <Footer />
      <DemoBottomSheet sector="about" open={sheetOpen} onClose={() => setSheetOpen(false)} />
    </div>
  );
}
