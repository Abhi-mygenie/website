...
export default function ProductIndex() {
  ...
  return (
    <div className="bg-white" data-testid="product-index">
      ...
      <main>
        {/* HERO */}
        <section className="relative pt-20 pb-16 lg:pt-40 lg:pb-20 overflow-hidden" data-testid="product-index-hero">
        ...
        <section className="py-20 sm:py-24" data-testid="product-index-demo-section">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
            ...
            <Reveal delay={0.1}><div id="product-index-demo" className="scroll-mt-20"><DemoForm sector="product-index" shortForm /></div></Reveal>
          </div>
        </section>
      </main>
      <Footer />
      <DemoBottomSheet sector="product-index" open={sheetOpen} onClose={() => setSheetOpen(false)} />
    </div>
  );
}
