...
export default function BlogPost() {
  ...
  const jsonLd = {
    ...
    author: { "@type": "Person", name: post.author || "MyGenie Editorial Team" },
    publisher: {
      "@type": "Organization",
      name: "MyGenie POS",
        ...
        <article className="pt-32 pb-16">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-4 flex flex-wrap items-center gap-4 text-sm text-brand-muted">
              <span className="inline-flex items-center gap-1.5"><User className="w-4 h-4" /> {post.author || "MyGenie Editorial Team"}</span>
