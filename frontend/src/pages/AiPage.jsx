...
export default function AiPage() {
  ...
  return (
    <div className="bg-white" data-testid="ai-page">
      ...
      <main>
        {/* HERO */}
        <section className="bg-brand-deep text-brand-sand pt-20 pb-16 lg:pt-40 relative overflow-hidden" data-testid="ai-hero">
        ...
        <section className="py-20 sm:py-24" data-testid="ai-demo-section">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
            ...
            <Reveal delay={0.1}><div id="ai-demo" className="scroll-mt-20"><DemoForm sector="ai" shortForm /></div></Reveal>
          </div>
        </section>
      </main>
      <Footer />
      <DemoBottomSheet sector="ai" open={sheetOpen} onClose={() => setSheetOpen(false)} />
    </div>
  );
}
