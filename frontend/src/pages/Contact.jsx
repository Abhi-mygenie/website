...
function ContactTabs() {
  ...
  return (
    <div data-testid="contact-tabs">
      ...
      {tab === "message" ? <MessageForm /> : <DemoForm sector="contact" shortForm />}
    </div>
  );
}
...
export default function Contact() {
  ...
  return (
    <div className="bg-white" data-testid="contact-page">
      <Seo title={seo.title} description={seo.description} path="/contact" jsonLd={[jsonLd, BREADCRUMB_JSONLD]} />
      ...
      <Footer />
      <DemoBottomSheet sector="contact" open={sheetOpen} onClose={() => setSheetOpen(false)} />
    </div>
  );
}
