...
export default function SolutionsIndex() {
  ...
  return (
    <div className="bg-white" data-testid="solutions-index">
      ...
      <main>
        {/* HERO */}
        <section className="relative pt-20 pb-16 lg:pt-40 lg:pb-20 overflow-hidden" data-testid="solutions-hero">
        ...
        {/* DEMO */}
        <section className="py-20 sm:py-24" data-testid="solutions-demo-section">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
            ...
            <Reveal delay={0.1}><div id="solutions-demo" className="scroll-mt-20"><DemoForm sector="solutions" shortForm /></div></Reveal>
          </div>
        </section>
      </main>
      <Footer />
      <DemoBottomSheet sector="solutions" open={sheetOpen} onClose={() => setSheetOpen(false)} />
    </div>
  );
}
