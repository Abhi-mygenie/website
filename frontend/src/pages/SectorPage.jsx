...
export default function SectorPage() {
  ...
  return (
    <div className="bg-white" data-testid="sector-page">
      ...
      <main>
        {/* HERO */}
        <section className="relative pt-20 pb-16 lg:pt-40 lg:pb-20 overflow-hidden" data-testid="sector-hero">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <button type="button" onClick={() => setSheetOpen(true)} data-testid="sector-hero-cta" className="group mt-8 inline-flex items-center gap-2 bg-brand-green hover:bg-brand-greenDark text-white rounded-full px-7 py-4 font-semibold transition-all hover:-translate-y-0.5 shadow-[0_10px_26px_rgba(24,168,74,0.32)]">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-12 items-center">
            ...
            <Reveal delay={0.1}>
              <div id="sector-demo" className="scroll-mt-20">
                <DemoForm sector={s.slug} shortForm />
              </div>
            </Reveal>
          </div>
        </section>
      ...
      <DemoBottomSheet sector={s.slug || s.name} open={sheetOpen} onClose={() => setSheetOpen(false)} />
    </div>
  );
}