...
const BREADCRUMB_JSONLD = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "ROI Calculator", item: `${SITE_URL}/roi` },
  ],
};
...
export default function RoiCalculator() {
  ...
  return (
    <div className="bg-white" data-testid="roi-page">
      <Seo title={PAGE_SEO["/roi"].title} description={PAGE_SEO["/roi"].description} path="/roi" jsonLd={[BREADCRUMB_JSONLD]} />
      <Navbar />
