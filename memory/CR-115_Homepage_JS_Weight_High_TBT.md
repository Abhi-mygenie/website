...
**Status:** OPEN — scope expanded 2026-08-23 to include PostHog deferral
**Priority:** HIGH
**Effort:** ~1–2 days
**Improves:** TBT · TTI · Google Ads Landing Page Experience
**Scope:** `frontend/src/pages/Home.jsx` + homepage section components, framer-motion usage, PostHog init (`public/index.html`)
**Related:** CR-101 (prerender POC), CR-72 (route code-splitting), CR-117 (prerender cleanup)
